...
#
#   ./scripts/smoke_test.sh                          # against localhost:5055
...
# 2. sign in ----------------------------------------------------------------
echo "2. sign in"
check "session created" 201 "$(call POST /api/session '{"name":"Smoke Test User"}')"
USER_ID=$(json user id)

# 3. create scoreboard ------------------------------------------------------
echo "3. create scoreboard"
...
# 8. reads ------------------------------------------------------------------
echo "8. leaderboard / history / analysis"
